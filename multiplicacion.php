...
<?php
    ...
    $multiplicacion = Multiplicacion($valores);
    echo "<h2>El resultado de la operacion es </h2> <input type='text' value='$multiplicacion'>";
